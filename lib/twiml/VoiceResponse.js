...
VoiceResponse.prototype.connect = function connect(attributes) {
  return new Connect(this.response.elem('Connect', attributes));
};
...
VoiceResponse.prototype.dial = function dial(attributes, number) {
  return new Dial(this.response.elem('Dial', attributes, number));
};
...
VoiceResponse.prototype.echo = function echo(attributes) {
  return new Echo(this.response.elem('Echo', attributes));
};
...
VoiceResponse.prototype.enqueue = function enqueue(attributes, name) {
  return new Enqueue(this.response.elem('Enqueue', attributes, name));
};
...
VoiceResponse.prototype.gather = function gather(attributes) {
  return new Gather(this.response.elem('Gather', attributes));
};
...
VoiceResponse.prototype.hangup = function hangup(attributes) {
  return new Hangup(this.response.elem('Hangup', attributes));
};
...
VoiceResponse.prototype.leave = function leave(attributes) {
  return new Leave(this.response.elem('Leave', attributes));
};
...
VoiceResponse.prototype.pause = function pause(attributes) {
  return new Pause(this.response.elem('Pause', attributes));
};
...
VoiceResponse.prototype.play = function play(attributes, url) {
  return new Play(this.response.elem('Play', attributes, url));
};
...
VoiceResponse.prototype.queue = function queue(attributes, name) {
  return new Queue(this.response.elem('Queue', attributes, name));
};
...
VoiceResponse.prototype.record = function record(attributes) {
  return new Record(this.response.elem('Record', attributes));
};
...
VoiceResponse.prototype.redirect = function redirect(attributes, url) {
  return new Redirect(this.response.elem('Redirect', attributes, url));
};
...
VoiceResponse.prototype.reject = function reject(attributes) {
  return new Reject(this.response.elem('Reject', attributes));
};
...
VoiceResponse.prototype.say = function say(attributes, message) {
  return new Say(this.response.elem('Say', attributes, message));
};
...
VoiceResponse.prototype.sms = function sms(attributes, message) {
  return new Sms(this.response.elem('Sms', attributes, message));
};
...
VoiceResponse.prototype.pay = function pay(attributes) {
  return new Pay(this.response.elem('Pay', attributes));
};
...
VoiceResponse.prototype.prompt = function prompt(attributes) {
  return new Prompt(this.response.elem('Prompt', attributes));
};
...
VoiceResponse.prototype.start = function start(attributes) {
  return new Start(this.response.elem('Start', attributes));
};
...
VoiceResponse.prototype.stop = function stop(attributes) {
  return new Stop(this.response.elem('Stop', attributes));
};
...
VoiceResponse.prototype.refer = function refer(attributes) {
  return new Refer(this.response.elem('Refer', attributes));
};
...
Refer.prototype.sip = function sip(attributes, sipUrl) {
  return new ReferSip(this.refer.elem('Sip', attributes, sipUrl));
};
...
Stop.prototype.stream = function stream(attributes) {
  return new Stream(this.stop.elem('Stream', attributes));
};
...
Stop.prototype.siprec = function siprec(attributes) {
  return new Siprec(this.stop.elem('Siprec', attributes));
};
...
Siprec.prototype.parameter = function parameter(attributes) {
  return new Parameter(this.siprec.elem('Parameter', attributes));
};
...
Stream.prototype.parameter = function parameter(attributes) {
  return new Parameter(this.stream.elem('Parameter', attributes));
};
...
Start.prototype.stream = function stream(attributes) {
  return new Stream(this.start.elem('Stream', attributes));
};
...
Start.prototype.siprec = function siprec(attributes) {
  return new Siprec(this.start.elem('Siprec', attributes));
};
...
Prompt.prototype.say = function say(attributes, message) {
  return new Say(this.prompt.elem('Say', attributes, message));
};
...
Prompt.prototype.play = function play(attributes, url) {
  return new Play(this.prompt.elem('Play', attributes, url));
};
...
Prompt.prototype.pause = function pause(attributes) {
  return new Pause(this.prompt.elem('Pause', attributes));
};
...
Say.prototype.break_ = function break_(attributes) {
  return new SsmlBreak(this.say.elem('break', attributes));
};
...
Say.prototype.emphasis = function emphasis(attributes, words) {
  return new SsmlEmphasis(this.say.elem('emphasis', attributes, words));
};
...
Say.prototype.lang = function lang(attributes, words) {
  return new SsmlLang(this.say.elem('lang', attributes, words));
};
...
Say.prototype.p = function p(attributes, words) {
  return new SsmlP(this.say.elem('p', attributes, words));
};
...
Say.prototype.phoneme = function phoneme(attributes, words) {
  return new SsmlPhoneme(this.say.elem('phoneme', attributes, words));
};
...
Say.prototype.prosody = function prosody(attributes, words) {
  return new SsmlProsody(this.say.elem('prosody', attributes, words));
};
...
Say.prototype.s = function s(attributes, words) {
  return new SsmlS(this.say.elem('s', attributes, words));
};
...
Say.prototype.sayAs = function sayAs(attributes, words) {
  return new SsmlSayAs(this.say.elem('say-as', attributes, words));
};
...
Say.prototype.sub = function sub(attributes, words) {
  return new SsmlSub(this.say.elem('sub', attributes, words));
};
...
Say.prototype.w = function w(attributes, words) {
  return new SsmlW(this.say.elem('w', attributes, words));
};
...
Pay.prototype.prompt = function prompt(attributes) {
  return new Prompt(this.pay.elem('Prompt', attributes));
};
...
Pay.prototype.parameter = function parameter(attributes) {
  return new Parameter(this.pay.elem('Parameter', attributes));
};
...
Gather.prototype.say = function say(attributes, message) {
  return new Say(this.gather.elem('Say', attributes, message));
};
...
Gather.prototype.pause = function pause(attributes) {
  return new Pause(this.gather.elem('Pause', attributes));
};
...
Gather.prototype.play = function play(attributes, url) {
  return new Play(this.gather.elem('Play', attributes, url));
};
...
Enqueue.prototype.task = function task(attributes, body) {
  return new Task(this.enqueue.elem('Task', attributes, body));
};
...
Dial.prototype.client = function client(attributes, identity) {
  return new Client(this.dial.elem('Client', attributes, identity));
};
...
Dial.prototype.conference = function conference(attributes, name) {
  return new Conference(this.dial.elem('Conference', attributes, name));
};
...
Dial.prototype.number = function number(attributes, phoneNumber) {
  return new Number(this.dial.elem('Number', attributes, phoneNumber));
};
...
Dial.prototype.queue = function queue(attributes, name) {
  return new Queue(this.dial.elem('Queue', attributes, name));
};
...
Dial.prototype.sim = function sim(attributes, simSid) {
  return new Sim(this.dial.elem('Sim', attributes, simSid));
};
...
Dial.prototype.sip = function sip(attributes, sipUrl) {
  return new Sip(this.dial.elem('Sip', attributes, sipUrl));
};
...
Client.prototype.identity = function identity(attributes, clientIdentity) {
  return new Identity(this.client.elem('Identity', attributes, clientIdentity));
};
...
Client.prototype.parameter = function parameter(attributes) {
  return new Parameter(this.client.elem('Parameter', attributes));
};
...
Connect.prototype.room = function room(attributes, name) {
  return new Room(this.connect.elem('Room', attributes, name));
};
...
Connect.prototype.autopilot = function autopilot(attributes, name) {
  return new Autopilot(this.connect.elem('Autopilot', attributes, name));
};
...
Connect.prototype.stream = function stream(attributes) {
  return new Stream(this.connect.elem('Stream', attributes));
};
